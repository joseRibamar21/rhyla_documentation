...
// Objeto RhylaClient com a funcionalidade expressConfig
const RhylaClient = {
    /**
...
/**
 * Função utilitária para criar URLs com o prefixo base
 * @param {string} base - O prefixo da base (ex: '/docs')
 * @param {string} path - O caminho a ser prefixado
 * @returns {string} - O caminho completo combinado
 */
...
// Exporta RhylaClient e utilitários
export { RhylaClient };
